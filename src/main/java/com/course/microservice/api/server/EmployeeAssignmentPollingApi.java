...
public class EmployeeAssignmentPollingApi {
	...
	public ResponseEntity<PlainMessage> deleteAssignment(@PathVariable(name = "assignment_id", required = true) long assignmentPollingId)
	...
	public ResponseEntity<PlainMessage> insertAssignment(@RequestBody(required = true) EmployeeAssignmentPollingRequest requestBody)
			                                                                                             throws JsonProcessingException {
